 ...
 */
public class GMapTile {
	private String keyholeString;

	/**
	 * Constructor with Keyhole string, e.g. "trstsrqt"
	 */
	private GMapTile(String aKeyholeString) {
		keyholeString = aKeyholeString;
	}
	 ...
	 */
	public BufferedImage getDebugTile() {
