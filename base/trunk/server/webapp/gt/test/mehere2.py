...
class mehere:
	...
	def __init__(self):
		self.configPath = os.path.expanduser("~") + os.sep + "mehere.ini"
					...
					<div id="menu">
						...
						<ul>
						   <li>
  							...
  							<li><a href="/shutdown" onclick="return confirm('Are you sure?');">Shutdown Tracker</a></li>
							<li><a href="http://mehere.glenmurphy.com/">Go to the MeHere website</a></li>
							<li><a href="http://www.geotracing.com/gt/test/localgps.html">Login to GeoTracing (not Safari)</a></li>
						</ul>
					</div>
				</body>
			</html>""")
