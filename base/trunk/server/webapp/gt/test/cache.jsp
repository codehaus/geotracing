...
<a href="cache.jsp?action=detail&cacheName=<%=cacheName%>">Region Detail</a>
...
%>
        <tr>
            ...
            <td>
             <a href="cache.jsp?action=item&cacheName=<%=cacheName%>&key=<%=element.getKey()%>"> View </a>
            | <a href="cache.jsp?action=remove&cacheName=<%=cacheName%>&key=<%=element.getKey()%>"> Remove </a>
            </td>
        </tr>
<%
    }
...
below. You can also <a href="javascript:decision('Clicking OK will clear all the data from all regions!','cache.jsp?action=clearAllRegions')">Clear all regions</a>
...
%>
        <tr>
            ...
            <td>
                <a href="cache.jsp?action=regionSummary&cacheName=<%=record.getCache().getCacheName()%>"> Summary </a>
                | <a href="cache.jsp?action=detail&cacheName=<%=record.getCache().getCacheName()%>"> Detail </a>
                | <a href="javascript:decision('Clicking OK will remove all the data from the region [<%=record.getCache().getCacheName()%>]!','cache.jsp?action=clearRegion&cacheName=<%=record.getCache().getCacheName()%>')"> Clear </a>
            </td>
        </tr>
<%
    }
