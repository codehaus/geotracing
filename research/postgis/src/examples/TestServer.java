...
public class TestServer {
	...
	public static void main(String[] args) {
		...
		// String dburl = "jdbc:postgresql://localhost:5432/gistest"; // args[0];
		String dburl = "jdbc:postgresql_lwgis://localhost:5432/gistest"; // args[0];
		...
		try {
			...
			/*
						 ...
						 */
			p("conn.getClass().getName()=" + conn.getClass().getName());
/*			if (conn.getClass().getName().equals("org.postgresql.jdbc2.Connection")) {
			...
			while (r.next()) {
				...
				int id = r.getInt(2);
				p("Row " + id + ":");
				p("obj: class=" + obj.getClass().getName() + " s=" + obj.toString());
			}
			s.close();
			conn.close();
		} catch (Exception e) {
