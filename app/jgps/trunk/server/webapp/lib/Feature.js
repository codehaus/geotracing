...
// $Id: Feature.js 244 2007-01-07 21:23:59Z just $

DH.include('LocationApp.js');
var FEAT = {
	current: null
}
...
function Feature(theId, name, desc, type, time, lon, lat, actie, oplossing) {
	...
	this.show = function() {
		...
		this.onMouseclickIcon = function(e)
		{
			LOCAPP.test();	
		}
		
		DH.addEvent(DH.getObject(this.iconId), 'mouseover', this.onMouseOverIcon, false);
	//	DH.addEvent(DH.getObject(this.iconId), 'click', this.onMouseclickIcon, false);
	}
