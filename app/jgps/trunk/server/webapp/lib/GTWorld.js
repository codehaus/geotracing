 ...
 *
 * $Id: GTWorld.js 214 2006-12-07 15:40:51Z just $
 */
...
/** Create new Medium object. */
	createMedium: function(id, name, desc, type, mime, time, lon, lat, subtype, locid) {
		var medium = GTW.factory.create('Medium', id, name, desc, type, mime, time, lon, lat, subtype, locid);
		// medium.init();
