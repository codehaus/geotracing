...
public class TraceDisplay extends Form implements CommandListener  {
    ...
    Command NEW_TRK_CMD = new Command(Locale.get("trace.New"), Command.ITEM, 2);
    Command SUSPEND_TRK_CMD = new Command(Locale.get("trace.Suspend"), Command.ITEM, 2);
    Command RESUME_TRK_CMD = new Command(Locale.get("trace.Resume"), Command.ITEM, 2);
    Command ADD_TEXT_CMD = new Command(Locale.get("trace.AddText"), Command.ITEM, 2);
    Command ADD_PHOTO_CMD = new Command(Locale.get("trace.AddPhoto"), Command.ITEM, 2);
    Command ADD_AUDIO_CMD = new Command(Locale.get("trace.AddAudio"), Command.ITEM, 2);
    Command SHOW_MAP_CMD = new Command(Locale.get("trace.ShowMap"), Command.ITEM, 2);
    Command RADAR_CMD = new Command(Locale.get("trace.Radar"), Command.ITEM, 2);
...
//		setFullScreenMode(true);
	...
	void start() {
		...
		/*String versionMsg = tracerEngine.versionCheck();
		if (versionMsg != null) {
		...
		*//*hideCommands();*//*
		switch (CMDS[cmdIndex]) {
			case CMD_SUSPEND_RESUME:
				...
				CMD_LABELS[cmdIndex] = tracerEngine.isPaused() ? "Resume Track" : "Suspend Track";
				break;
