...
public class MapLogic {
    ...
    public String getMapURL(Point urt, Point llb, int width, int height) throws UtopiaException {
        ...
        return "" + MAPPING_URL + "?LAYERS=topnl_diwiwms,diwi_pois&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&STYLES=&EXCEPTIONS=application%2Fvnd.ogc.se_inimage&FORMAT=image%2Fjpeg&SRS=EPSG%3A28992&BBOX=" + boxString + "&WIDTH=" + width + "&HEIGHT=" + height;
    }
